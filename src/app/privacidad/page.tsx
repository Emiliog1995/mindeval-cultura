    ...
    <div className="min-h-screen" style={{ background: "#f0f4f8" }}>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <div className="bg-white rounded-2xl shadow p-8 space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <div>
            <h1 className="text-2xl font-bold mb-1" style={{ color: "#1a2035" }}>Aviso de Privacidad</h1>
            <p className="text-xs text-gray-400">Última actualización: junio 2025</p>
          </div>

          <section className="space-y-2">
            <h2 className="font-bold text-base" style={{ color: "#1a2035" }}>1. Responsable del tratamiento</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base" style={{ color: "#1a2035" }}>2. Datos que recopilamos</h2>
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base" style={{ color: "#1a2035" }}>3. Finalidad del tratamiento</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base" style={{ color: "#1a2035" }}>4. Base legal</h2>
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base" style={{ color: "#1a2035" }}>5. Conservación de los datos</h2>
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base" style={{ color: "#1a2035" }}>6. Transferencia internacional</h2>
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base" style={{ color: "#1a2035" }}>7. Sus derechos (ARCO)</h2>
          ...
          <section className="space-y-2">
            <h2 className="font-bold text-base" style={{ color: "#1a2035" }}>8. Seguridad</h2>
          ...
          <div className="rounded-xl px-4 py-3 text-xs" style={{ background: "#f8f6f0", borderLeft: "3px solid #c9a84c", color: "#1a2035" }}>
