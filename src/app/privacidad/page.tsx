        ...
        <div className="bg-white rounded-2xl shadow p-8 space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong>Proceso de selección de personal (MindEval Selección):</strong> nombre completo, número de cédula, email, teléfono, ciudad, años de experiencia, educación y su hoja de vida (CV), así como sus respuestas a pruebas psicométricas (16PF-5, KOSTICK, DISC), pruebas técnicas y ejercicios de assessment center aplicados durante el proceso de reclutamiento. Durante estas pruebas también registramos señales técnicas de integridad (cambios de pestaña, salidas de pantalla completa, copiar/pegar) para resguardar la validez del proceso. Si su vacante lo requiere, verificamos el título académico que usted declaró contra el registro público de la SENESCYT, en algunos casos con la asistencia de un proveedor externo especializado en este tipo de consultas. Estos datos se usan exclusivamente para evaluar su idoneidad para la vacante a la que postuló.</li>
            </ul>
          </section>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Evaluar la idoneidad de candidatos dentro de un proceso de selección de personal (análisis de CV, pruebas psicométricas, técnicas y de assessment center).</li>
              <li>Resguardar la integridad de las pruebas de selección mediante señales técnicas de comportamiento (sin grabación de video ni audio).</li>
              <li>Verificar la autenticidad de los títulos académicos declarados por el candidato, consultando el registro público de la SENESCYT.</li>
              <li>Mejorar los instrumentos y metodologías de diagnóstico organizacional.</li>
            </ul>
            <p>Sus respuestas de cultura y clima se reportan <strong>únicamente de forma grupal por área</strong>. Su nombre nunca aparecerá vinculado a sus respuestas individuales en los informes organizacionales. La información de puestos y los resultados de un proceso de selección son accesibles solo para el área de Talento Humano de la empresa contratante y el consultor de MINDTALENT asignado.</p>
          </section>
