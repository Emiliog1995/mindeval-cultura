        ...
        <div className="bg-white rounded-2xl shadow p-8 space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong>Proceso de selección de personal (MindEval Selección):</strong> nombre completo, email, teléfono, ciudad, años de experiencia, educación y su hoja de vida (CV), así como sus respuestas a pruebas psicométricas (16PF-5, KOSTICK, DISC), pruebas técnicas y ejercicios de assessment center aplicados durante el proceso de reclutamiento. Durante estas pruebas también registramos señales técnicas de integridad (cambios de pestaña, salidas de pantalla completa, copiar/pegar) para resguardar la validez del proceso. Si su vacante lo requiere, verificamos el título académico que usted declaró contra el registro público de la SENESCYT. Estos datos se usan exclusivamente para evaluar su idoneidad para la vacante a la que postuló.</li>
            </ul>
          </section>
